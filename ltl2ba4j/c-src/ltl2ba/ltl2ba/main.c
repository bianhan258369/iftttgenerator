...
char	uform[4096];    /* RENE: removed static */
int	hasuform=0, cnt=0;  /* RENE: removed static */
...
#define Binop(a) fprintf(tl_out, "("); dump(n->lft); fprintf(tl_out, a); dump(n->rgt); fprintf(tl_out, ")")
